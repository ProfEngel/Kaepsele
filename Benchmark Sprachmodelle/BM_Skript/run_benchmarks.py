...
async def run_all_benchmarks(vllm_url, api_key, use_long_context):
    configurations = [
        ...
        {"num_requests": 1000, "concurrency": 150, "output_tokens": 100},
        {"num_requests": 1000, "concurrency": 200, "output_tokens": 100},
        {"num_requests": 1000, "concurrency": 250, "output_tokens": 100},
        {"num_requests": 1000, "concurrency": 300, "output_tokens": 100},
        {"num_requests": 1000, "concurrency": 350, "output_tokens": 100},
        {"num_requests": 1000, "concurrency": 400, "output_tokens": 100},
        {"num_requests": 1000, "concurrency": 450, "output_tokens": 100},
